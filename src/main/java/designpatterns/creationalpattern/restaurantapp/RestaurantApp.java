...
import com.example.designpatterns.creationalpattern.restaurantapp.kitchen.ItalianRestaurant;
import com.example.designpatterns.creationalpattern.restaurantapp.kitchen.MexicanRestaurant;
import com.example.designpatterns.creationalpattern.restaurantapp.kitchen.Restaurant;
import com.example.designpatterns.creationalpattern.restaurantapp.service.MenuService;
 ...
 *
 * <dl>
 *     <dt><b>com.example.restaurantapp.model</b></dt>
 *     <dd>
 *         Contains the core data structures of the application.
 *         <ul>
 *             <li><b>Builder Pattern:</b> The {@link com.example.designpatterns.creationalpattern.restaurantapp.model.Meal} class uses a static nested {@code MealBuilder} to construct complex meal objects step-by-step. This provides a readable and flexible way to create objects with many optional parts.</li>
 *             <li><b>Prototype Pattern:</b> The {@link com.example.designpatterns.creationalpattern.restaurantapp.model.Meal} class implements the {@code CloneableMeal} interface, allowing instances to be cloned. This is used for creating copies of pre-defined meals from the menu.</li>
 *         </ul>
 *     </dd>
 *
 *     <dt><b>com.example.restaurantapp.service</b></dt>
 *     <dd>
 *         Contains application-wide services.
 *         <ul>
 *             <li><b>Singleton Pattern:</b> The {@link com.example.designpatterns.creationalpattern.restaurantapp.service.MenuService} is a Singleton. This ensures there is only one instance of the menu service in the entire application, providing a single, global point of access to the restaurant's menu.</li>
 *         </ul>
 *     </dd>
 *
 *     <dt><b>com.example.restaurantapp.kitchen</b></dt>
 *     <dd>
 *         Represents the area where food is prepared and contains the factory-related logic.
 *         <ul>
 *             <li><b>Factory Method Pattern:</b> The abstract {@link com.example.designpatterns.creationalpattern.restaurantapp.kitchen.Restaurant} class defines a "factory method" (`getMealFactory()`). Subclasses like {@link com.example.designpatterns.creationalpattern.restaurantapp.kitchen.ItalianRestaurant} and {@link com.example.designpatterns.creationalpattern.restaurantapp.kitchen.MexicanRestaurant} implement this method to provide a specific factory, deferring the choice of which factory to create to the subclasses.</li>
